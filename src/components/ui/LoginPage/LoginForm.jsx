...
const LoginForm = () => {
  return (
    <form className="md:w-1/2 w-full flex flex-col justify-center p-8 bg-base-dark">
      ...
      <button className="bg-brandColor text-base-light font-bold py-2 px-4 rounded mt-4 hover:opacity-90 transition">
        تسجيل الدخول
      </button>
